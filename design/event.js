$(document).ready(function(){
    $(".slidecontainer").append(`  
        <div style="width: 0;">
          <div class="btn-slide scroll-left-btn" style="z-index:5;position:absolute; bottom: 50%; left: 54px; " height="510">
          ...
          <div class="btn-slide scroll-right-btn" style="z-index:5; position:absolute; bottom: 50%; right: 54px;" height="510">
