<nav style="border-bottom: solid black 1px;z-index: 10000; padding: 0 !important;" id="getheight"
        class="fixedtopint1 container-fluid navbar navbar-expand-lg navbar-light sticky-top top-0  mx-auto d-block bg-white flex-wrap d-flex justify-content-between">
        <div class="container-fluid d-flex justify-content-between position-relative ">     
            <div style=" padding: 60px 20%; border-top: 1px solid black;"  class="searcharea d-none container-fluid bg-white position-absolute top-100 start-0 end-0 text-dark ">
             <div style="flex-wrap: nowrap;">
                ...
                <button class="entersearch" rel="nofollow" target="_blank" style="background: none ;">
                    <i data-testid="nav-dp-l1-user-navigation-search-icon" class="styled__I-sc-1mg62fn-0 kcEkud"><svg width="24"
            ...
            <div class="collapse navbar-collapse d-flex align-items-center justify-content-center " id="navbarNav ">
                <ul class="navbar-nav ">
                    <li class="relativem nav-item me-5 needoffset">
                        <a id="checkleft" class="borderbottom position-relative nav-link" href="#">KIỂU DÁNG</a>
                    </li>
                    <li class="relativem nav-item me-5">
                        <a class="borderbottom position-relative nav-link text-dark" href="#">THƯƠNG HIỆU</a>
                    </li>
                    <li class="relativem nav-item me-5">
                        <a class="borderbottom position-relative nav-link text-dark" href="#">LOẠI GỌNG</a>
                    </li>
